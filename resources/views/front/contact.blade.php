...
@section('content')
    <section class="mdp-contact">
        ...
        <main>
            <p>Je vous accueille sur <span class="italic">rendez-vous</span> du <span class="bold">lundi au samedi de 9h à 19h</span> (nocturne possible), dans un espace pensé pour vous et dédié à votre bien-être. </p>
            ...
            <form>
                ...
                <input type="text" name="" placeholder="Votre adresse mail" />
