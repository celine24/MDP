        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"><h1>Créer une nouvelle actualité</h1></div>
                        ...
                        <div class="panel-body">
                                ...
                                {!! Form::open(['route' => ['admin.actu.store'], 'id' => 'form-main', 'class' => 'center-block']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="link" class="form-control">
                                        ...
                                        <option value="{{$post->link . $post->id}}">{{$post->category->name . ' : ' . $post->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="mdp-form-inline">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox-success pull-right">
                                            {!! Form::checkbox('displayed_link', '1', false, ['id' => 'checkbox2', 'class' => 'checkbox checkbox-success']) !!}
